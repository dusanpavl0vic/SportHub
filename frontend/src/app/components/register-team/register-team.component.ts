...
export class RegisterTeamComponent {
  ...
  constructor() {
    ...
    this.registerTeamForm = this.fb.group<RegisterTeamForm>({
      ...
      sportid: this.fb.control(0, { nonNullable: true, validators: [Validators.required, Validators.min(1)] }),
    });
  }
  ...
  get getPasswordContorl(): FormControl {
    return this.registerTeamForm.get('password') as FormControl;
  }
  ...
  get getSportIdControl(): FormControl {
    return this.registerTeamForm.get('sportid') as FormControl;
  }
