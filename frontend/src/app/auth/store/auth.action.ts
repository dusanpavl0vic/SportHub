...
import { RegisterPlayerRequest, RegisterTeamRequest } from 'src/app/auth/service/auth.service';
import { Role } from 'src/enum/role.enum';
import { Player } from 'src/interfaces/player/player.dto';
import { Team } from 'src/interfaces/team/team.dto';

export const login = createAction('[Auth] Login', props<{ email: string; password: string }>());
export const loginSuccess = createAction('[Auth] Login Success', props<{ token: string, user: Player | Team, role: Role }>());
export const loginFailure = createAction('[Auth] Login Failure', props<{ error: string }>());

export const registerPlayer = createAction('[Auth] Register Player', props<{ data: RegisterPlayerRequest }>());
export const registerPlayerSuccess = createAction('[Auth] Register Player Success', props<{ token: string, player: Player, role: Role }>());
...
export const registerTeamSuccess = createAction('[Auth] Register Team Success', props<{ token: string, team: Team, role: Role }>());
